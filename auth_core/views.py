...
def LoginView(request):
    ...
    return render(request, 'auth_core/login.html')
...
def ForgotPassword(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            password_reset_url = reverse('auth_reset_password', kwargs={'reset_id': new_password_reset.reset_id})
            ...
            return redirect('auth_password_reset_sent', reset_id=new_password_reset.reset_id)
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if not passwords_have_error:
                ...
                return redirect('auth_reset_password', reset_id=reset_id)
